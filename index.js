...
function customObjectFromEntries(entries) {
  ...
  const processedEntires = entries.map(([key, value]) => {
  ...
  const newObj = Object.fromEntries(processedEntires);
...
function getObjectValuesSum(obj) {
  ...
  const sumObj = valueObj.reduce((value1, value2) => value1 + value2, 0);
